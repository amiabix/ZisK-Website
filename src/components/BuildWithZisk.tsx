...
export const BuildWithZisk = () => {
  return (
    <section className="pt-20 lg:pt-32 pb-20 lg:pb-32 relative overflow-hidden group">
      ...
      <div className="container mx-auto px-6 lg:px-12 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <h2 className="text-4xl lg:text-6xl font-display font-semibold tracking-tight">
