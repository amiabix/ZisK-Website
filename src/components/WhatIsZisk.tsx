export const WhatIsZisk = () => {
  return (
    <section id="what-is-zisk" className="relative pt-8 lg:pt-12 pb-12 sm:pb-16 lg:pb-32 overflow-hidden group">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        <div className="flex flex-col lg:flex-row">
          ...
          <div className="flex-1 max-w-4xl relative">
            ...
            <div className="hidden lg:block absolute h-px bg-border" style={{ 
              top: '-18%',
              left: 'calc(-10% - 0.5rem)', 
