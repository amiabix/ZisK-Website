      ...
      <div className="container mx-auto px-6 lg:px-12">
        <div className="flex h-16 items-center justify-between">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Button 
              className="bg-[#007755] border border-[#F3f3f2]/30 text-white transition-smooth font-medium group gap-1.5 rounded-none text-xs sm:text-sm"
              asChild
            >
              <a href="#contact">
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-muted-foreground hover:text-[#0ABF83] transition-smooth font-medium flex items-center gap-1 sm:gap-1.5 group"
            >
              <span className="hidden sm:inline text-xs sm:text-sm">Developer Assistance</span>
